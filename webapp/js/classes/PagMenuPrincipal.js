function PagMenuPrincipal() {
	...
	this.montaPagHtml = function() {
		...
		button.setAttribute("style", "border-radius: 0.4em 0 0 0.4em; border-right-color: #bbbbbb;");
		...
		button.setAttribute("class", "zoomControle");
		button.setAttribute("style", "border-radius: 0 0.4em 0.4em 0; border-left-color: #bbbbbb;");
